...
- **Independent versioning** — `majorCodeOss.minorCodeOss.openideRevision`
  (currently `1.121.1`), which keeps extensions compatible while allowing
...
| `openide-version.json` | Current version, channel, and the Code OSS commit reference. |
...
This repository keeps the MIT license inherited from the base project. See
[LICENSE](./LICENSE).
