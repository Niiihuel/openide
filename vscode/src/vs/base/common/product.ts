...
export interface IProductConfiguration {
	...
	/**
	 * OpenIDE's own product version, independent of `version` (which carries the Code OSS API
	 * level that extension `engines.vscode` ranges are validated against). Only display surfaces
	 * and the OpenIDE update feed should read this one.
	 */
	readonly openideVersion?: string;
	readonly openideUpdateKeyId?: string;
	readonly openideUpdatePublicKey?: string;
	readonly openideUpdaterVersion?: number;
