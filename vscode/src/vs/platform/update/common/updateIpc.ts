...
export class UpdateChannel implements IServerChannel {
	...
	call(_: unknown, command: string, arg?: any): Promise<any> {
		switch (command) {
			...
			case 'cancelDownload': return this.service.cancelDownload();
			case 'recoverPreviousVersion': return this.service.recoverPreviousVersion();
...
export class UpdateChannelClient implements IUpdateService {
	...
	cancelDownload(): Promise<void> { return this.channel.call('cancelDownload'); }
	recoverPreviousVersion(): Promise<void> { return this.channel.call('recoverPreviousVersion'); }
