...
export class BrowserViewDebugger extends Disposable {
	...
	private ensureAttached(): void {
		...
		if (this.view.isDevToolsOpen) {
			throw new Error('The browser CDP transport is unavailable while Chromium DevTools are open.');
		}
	...
	/**
	 * Electron's debugger transport and Chromium DevTools are mutually exclusive. Release all
	 * proxy sessions before opening the user-facing DevTools frontend; groups can attach fresh
	 * sessions after DevTools closes.
	 */
	releaseForDevTools(): void {
