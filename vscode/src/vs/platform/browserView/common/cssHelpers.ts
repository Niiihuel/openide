...
export const keyComputedProperties = new Set([
	...
	'top', 'right', 'bottom', 'left', 'z-index', 'box-sizing', 'overflow', 'overflow-x', 'overflow-y',
	'width', 'height', 'min-width', 'min-height', 'max-width', 'max-height',
	'flex', 'flex-direction', 'flex-wrap', 'align-items', 'align-content', 'justify-content', 'gap',
	'grid-template-columns', 'grid-template-rows', 'grid-auto-flow',
	'border', 'border-radius', 'opacity', 'font-size', 'font-family', 'font-weight', 'line-height',
