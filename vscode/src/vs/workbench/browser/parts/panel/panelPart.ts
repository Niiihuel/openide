...
import { OPENIDE_ISLAND_BACKGROUND, PANEL_BORDER, PANEL_TITLE_BORDER, PANEL_ACTIVE_TITLE_FOREGROUND, PANEL_INACTIVE_TITLE_FOREGROUND, PANEL_ACTIVE_TITLE_BORDER, PANEL_DRAG_AND_DROP_BORDER, PANEL_TITLE_BADGE_BACKGROUND, PANEL_TITLE_BADGE_FOREGROUND } from '../../../common/theme.js';
...
export class PanelPart extends AbstractPaneCompositePart {
	...
	protected getCompositeBarOptions(): IPaneCompositeBarOptions {
		return {
			...
			colors: theme => ({
				activeBackgroundColor: theme.getColor(OPENIDE_ISLAND_BACKGROUND), // Background color for overflow action
				inactiveBackgroundColor: theme.getColor(OPENIDE_ISLAND_BACKGROUND), // Background color for overflow action
