...
import { OPENIDE_ISLAND_BACKGROUND, PANEL_SECTION_DRAG_AND_DROP_BACKGROUND, PANEL_STICKY_SCROLL_BORDER, PANEL_STICKY_SCROLL_SHADOW, SIDE_BAR_DRAG_AND_DROP_BACKGROUND, SIDE_BAR_STICKY_SCROLL_BORDER, SIDE_BAR_STICKY_SCROLL_SHADOW } from '../../../common/theme.js';
...
export function getLocationBasedViewColors(location: ViewContainerLocation | null): IViewPaneLocationColors {
	...
	switch (location) {
		case ViewContainerLocation.Panel:
			background = OPENIDE_ISLAND_BACKGROUND;
			overlayBackground = PANEL_SECTION_DRAG_AND_DROP_BACKGROUND;
			stickyScrollBackground = OPENIDE_ISLAND_BACKGROUND;
