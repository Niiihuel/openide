...
export const InAutomationContext = new RawContextKey<boolean>('inAutomation', false, localize('inAutomation', "Whether OpenIDE is running under automation/smoke test"));
...
export const EditorPartModalDockableContext = new RawContextKey<boolean>('editorPartModalDockable', false, localize('editorPartModalDockable', "Whether the modal belongs to a docked workspace"));
