...
export namespace ThemeSettingDefaults {
	export const COLOR_THEME_DARK = 'OpenIDE Dark';
	export const COLOR_THEME_LIGHT = 'OpenIDE Light';
...
export const COLOR_THEME_DARK_INITIAL_COLORS = {
	...
	// Kept in sync with extensions/theme-defaults/themes/openide-dark.json: this map paints the
	// first frame before the theme extension loads, so a border here reappears as a flash of the
	// hairline rectangle around every text field that the shipped theme no longer draws.
...
export const COLOR_THEME_LIGHT_INITIAL_COLORS = {
	...
	// Kept in sync with extensions/theme-defaults/themes/openide-light.json, same reason as the
	// dark map above: the pre-load frame must not draw a border the shipped theme dropped.
