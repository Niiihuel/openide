...
export const OPENIDE_SURFACE_STRINGS = {
	...
	'accounts.activity.title': { es: 'Actividad en GitHub', en: 'GitHub activity' },
	'accounts.activity.description': { es: 'Contribuciones de los últimos 12 meses', en: 'Contributions over the last 12 months' },
	'accounts.activity.total': { es: '{0} contribuciones en los últimos 12 meses', en: '{0} contributions over the last 12 months' },
	'accounts.activity.day': { es: '{0} contribuciones · {1}', en: '{0} contributions · {1}' },
	'accounts.activity.dayOne': { es: '{0} contribución · {1}', en: '{0} contribution · {1}' },
	'accounts.activity.less': { es: 'Menos', en: 'Less' },
	'accounts.activity.more': { es: 'Más', en: 'More' },
	'accounts.activity.refresh': { es: 'Actualizar', en: 'Refresh' },
	'accounts.activity.loading': { es: 'Cargando contribuciones…', en: 'Loading contributions…' },
	'accounts.activity.visibility': { es: 'Según la visibilidad y los permisos de tu cuenta de GitHub.', en: 'Based on your GitHub account visibility and permissions.' },
	'accounts.activity.session': { es: 'La sesión de GitHub no está disponible o venció. Reconectá tu cuenta y volvé a actualizar.', en: 'Your GitHub session is unavailable or expired. Reconnect your account and refresh.' },
	'accounts.activity.limited': { es: 'GitHub limitó la consulta o la cuenta no tiene acceso. Podés volver a intentar más tarde.', en: 'GitHub limited this request or the account does not have access. Try again later.' },
	'accounts.activity.error': { es: 'No se pudo actualizar la actividad de GitHub. Volvé a intentar cuando tengas conexión.', en: 'Could not update GitHub activity. Try again when you are connected.' },
} as const;
