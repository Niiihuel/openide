...
const STRINGS = {
	...
	'memory.capturePending': { en: 'Project memory is being saved in the background.', es: 'La memoria del proyecto se está guardando en segundo plano.' },
	'memory.captureNoChange': { en: 'Memory checked: no new durable information.', es: 'Memoria revisada: no hay información duradera nueva.' },
