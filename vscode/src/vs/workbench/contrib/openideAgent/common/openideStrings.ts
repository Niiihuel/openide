...
import { OPENIDE_COMMAND_STRINGS } from './openideCommandStrings.js';
import { OPENIDE_WELCOME_STRINGS } from './openideWelcomeStrings.js';
...
const STRINGS = {
	...
	// Same reason, three more surfaces: the command/settings registry of the agent contribution,
	// the welcome and getting-started overlay, and the update/composer/settings-tree labels. They
	// were split by surface rather than by size so several people can work without conflicting in
	// one file. `OpenideStringKey` still resolves across all of them.
	...OPENIDE_COMMAND_STRINGS,
	...OPENIDE_WELCOME_STRINGS,
	...
	'chat.model.edit': { es: 'Editar', en: 'Edit' },
	'chat.effort.auto': { es: 'Auto', en: 'Auto' },
	// ---- the empty transcript of a new chat
	'chat.empty.title': { es: 'Chat nuevo', en: 'New chat' },
	'chat.empty.text': { es: 'Escribí abajo para empezar.', en: 'Type below to start.' },
	'chat.empty.hintSlash': { es: 'para skills y comandos', en: 'for skills and commands' },
	'chat.empty.hintAt': { es: 'para archivos del proyecto', en: 'for project files' },
	'chat.empty.sessions': { es: 'Ver conversaciones guardadas', en: 'Browse saved conversations' },
	'chat.model.editEffort': { es: 'Nivel de razonamiento de {0}', en: "{0}'s reasoning level" },
	...
	'chat.video.title': { es: 'Grabación', en: 'Recording' },
	'chat.video.steps': { es: '{0} pasos', en: '{0} steps' },
	'chat.video.play': { es: 'Reproducir', en: 'Play' },
	'chat.video.openFolder': { es: 'Abrir la carpeta con el video, la lámina y los cuadros', en: 'Open the folder with the video, the sheet and the frames' },
	'chat.video.noVideo': { es: 'Este build no pudo codificar el video; quedan la lámina y los cuadros.', en: 'This build could not encode the video; the sheet and the frames are still there.' },
	'chat.video.missing': { es: 'Los archivos de la grabación ya no están en el disco.', en: 'The recording\'s files are no longer on disk.' },
	'chat.video.seek': { es: 'Ir al paso {0}: {1}', en: 'Go to step {0}: {1}' },
	...
	'language.ui.partial': { es: '{0} (solo la interfaz de VS Code)', en: '{0} (VS Code interface only)' },
	'language.ui.fetching': { es: 'Buscando el paquete de idioma de {0}…', en: 'Fetching the {0} language pack…' },
	'language.ui.packUnavailable': { es: 'No pude traer el paquete de idioma de {0} desde el marketplace. Revisá la conexión, o buscalo a mano en Extensiones.', en: 'Could not fetch the {0} language pack from the marketplace. Check your connection, or look it up by hand in Extensions.' },
	'language.ui.packSearch': { es: 'Buscar en Extensiones', en: 'Look it up in Extensions' },
	'language.mismatch.title': { es: 'Falta el paquete de idioma de {0}', en: 'The {0} language pack is missing' },
	'language.mismatch.text': { es: 'El idioma pedido es {0} — por tu sistema o por la configuración —, pero falta su paquete, así que OpenIDE arrancó en inglés. Instalalo y reiniciá: recién ahí la interfaz entera queda en {0}.', en: 'The requested language is {0} — from your system or your configuration — but its pack is missing, so OpenIDE started in English. Install it and restart: only then does the whole interface land in {0}.' },
	'language.mismatch.install': { es: 'Instalar el paquete de {0}', en: 'Install the {0} pack' },
	'language.callout.title': { es: 'Un solo idioma para todo', en: 'One language for everything' },
	'language.callout.text': { es: 'OpenIDE usa el idioma de la interfaz para sus propias pantallas, así que este selector mueve el IDE entero. OpenIDE está traducido a español e inglés; si elegís otro idioma, se traduce VS Code y las pantallas de OpenIDE quedan en inglés.', en: 'OpenIDE renders its own screens in the display language, so this selector moves the entire IDE. OpenIDE itself is translated into Spanish and English; pick another language and VS Code is translated while OpenIDE\'s screens stay in English.' },
	...
	'error.accountPolicy': { es: 'Tu credencial está bien: al proveedor le falta que confirmes algo en tu cuenta. Abrí el enlace del mensaje de arriba, confirmalo y volvé a enviar.', en: 'Your credential is fine: the provider needs something confirmed on your account. Open the link in the message above, confirm it and send again.' },
