...
export const OPENIDE_TOOL_META: Readonly<Record<string, IOpenideToolMeta>> = {
	...
	browser_debug_start: { icon: 'debug-start', verb: 'Starting browser diagnostics', done: 'Started browser diagnostics', key: '' },
	browser_debug_status: { icon: 'pulse', verb: 'Checking browser diagnostics', done: 'Checked browser diagnostics', key: '' },
	browser_debug_stop: { icon: 'debug-stop', verb: 'Stopping browser diagnostics', done: 'Stopped browser diagnostics', key: '' },
	browser_debug_discard: { icon: 'trash', verb: 'Discarding browser diagnostics', done: 'Discarded browser diagnostics', key: '' },
