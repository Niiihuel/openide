...
export interface IBrowserViewModel extends IDisposable {
	...
	toggleElementSelection(enabled?: boolean, purpose?: BrowserElementSelectionPurpose): Promise<void>;
...
export class BrowserViewModel extends Disposable implements IBrowserViewModel {
	...
	constructor(
		...
		this._register(this.onDidChangeElementSelectionActive(active => {
			if (active && this._elementSelectionPurpose === BrowserElementSelectionPurpose.Chat) {
	...
	async toggleElementSelection(enabled?: boolean, purpose = BrowserElementSelectionPurpose.Chat): Promise<void> {
		...
		this._elementSelectionPurpose = purpose;
		return this.browserViewService.toggleElementSelection(this.id, targetEnabled);
	}
