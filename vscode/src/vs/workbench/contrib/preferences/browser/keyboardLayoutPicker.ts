...
const DEFAULT_CONTENT: string = [
	`// ${nls.localize('displayLanguage', 'Defines the keyboard layout used in OpenIDE in the browser environment.')}`,
	`// ${nls.localize('doc', 'Open OpenIDE and run "Developer: Inspect Key Mappings (JSON)" from Command Palette.')}`,
	``,
