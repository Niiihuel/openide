...
export class SettingsTreeGroupElement extends SettingsTreeElement {
	...
	constructor(_id: string, count: number | undefined, label: string, level: number, isFirstGroup: boolean, readonly command?: string) {
		super(_id);
...
export class SettingsTreeModel implements IDisposable {
	...
	private createSettingsTreeGroupElement(tocEntry: ITOCEntry<ISetting>, parent?: SettingsTreeGroupElement): SettingsTreeGroupElement {
		...
		const element = new SettingsTreeGroupElement(tocEntry.id, undefined, tocEntry.label, depth, false, tocEntry.command);
