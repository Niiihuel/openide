			...
			children: [
				{
					...
					label: localize('openideAgentProviders', "Proveedores de IA")
				},
				{
					id: 'openideAgent/chat',
					label: localize('openideAgentChat', "Chat y ejecución"),
					settings: [
						'openide.chat.*',
				...
				},
				{
					...
					label: localize('openideAgentVoice', "Voz"),
					settings: [
				...
				},
				{
					...
					label: localize('openideAgentContext', "Contexto y límites"),
					settings: [
				...
				},
				{
					...
					label: localize('openideAgentCommands', "Comandos")
				},
				{
					id: 'openideAgent/quickCommands',
					label: localize('openideAgentQuickCommands', "Comandos rápidos de terminal")
				},
				{
					id: 'openideAgent/subagents',
					label: localize('openideAgentSubagents', "Subagentes"),
				...
				},
				{
					...
					label: localize('openideAgentNotifications', "Notificaciones"),
					settings: ['openide.agent.notifications.*']
				},
				{
					id: 'openideAgent/browser',
					label: localize('openideAgentBrowser', "Navegador"),
