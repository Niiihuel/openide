...
import { OpenideAgentHostMainService } from '../../platform/openideAgentHost/electron-main/openideAgentHostMain.js';
import { OPENIDE_AGENT_HOST_CHANNEL } from '../../platform/openideAgentHost/common/openideAgentHost.js';
import { OpenideBrowserAutomationMainService } from '../../platform/openideBrowser/electron-main/openideBrowserAutomationMainService.js';
import { OPENIDE_BROWSER_AUTOMATION_CHANNEL } from '../../platform/openideBrowser/common/openideBrowserAutomation.js';
import { OpenideRequestChannel, OPENIDE_REQUEST_CHANNEL } from '../../platform/request/common/openideRequestIpc.js';
import { RequestService as NodeRequestService } from '../../platform/request/node/requestService.js';
...
export class CodeApplication extends Disposable {
	...
	async startup(): Promise<void> {
		this.logService.debug('Starting OpenIDE');
