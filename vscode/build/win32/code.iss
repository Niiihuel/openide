...
AppPublisher=OpenIDE Team
AppPublisherURL=https://github.com/Niiihuel/openide
AppSupportURL=https://github.com/Niiihuel/openide/issues
AppUpdatesURL=https://github.com/Niiihuel/openide/releases
...
begin
  Result := True;
    ...
    if not WizardSilent() and IsAdmin() then begin
      if MsgBox('This User Installer is not meant to be run as an Administrator. If you would like to install {#NameLong} for all users in this system, download the System Installer instead from https://github.com/Niiihuel/openide/releases. Are you sure you want to continue?', mbError, MB_OKCANCEL) = IDCANCEL then begin
        Result := False;
      end;
    end;
  #endif
