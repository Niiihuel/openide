...
// Linux packages are named after the PRODUCT version, not `packageJson.version` -- the latter
// carries the Code OSS API level so that extension `engines.vscode` checks keep working, and it
// would name a 1.0.0 release `openide_1.121.0_amd64.deb`.
const productVersion = (product as typeof product & { openideVersion?: string }).openideVersion || packageJson.version;
