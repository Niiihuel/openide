...
<policyDefinitions revision="1.1" schemaVersion="1.0">
	<policyNamespaces>
		<target prefix="${regKey}" namespace="OpenIDE.Policies.${regKey}" />
	</policyNamespaces>
...
<dict>
    <key>pfm_app_url</key>
    <string>https://github.com/Niiihuel/openide</string>
...
${policyEntries}
		...
		<string>This profile manages ${appName}. For more information see https://github.com/Niiihuel/openide</string>
		<key>PayloadDisplayName</key>
		<string>${appName}</string>
		<key>PayloadIdentifier</key>
		<string>${bundleIdentifier}</string>
