...
const chatHtml = fs.readFileSync(path.join(root, 'src/vs/workbench/contrib/openideAgent/browser/openideChatHtml.ts'), 'utf8');
assert.match(chatHtml, /codicon codicon-filled codicon-openide-mode-agent/, 'no explicit filled icon consumer');
